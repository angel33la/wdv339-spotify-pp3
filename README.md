...
### Spotify API & Playback Prerequisites
- Spotify Developer Account
- Spotify API Key (Client ID and Client Secret)
- Spotify Web Playback SDK (for music playback functionality)
- OAuth 2.0 Authentication (for user login and access to Spotify data)
...
* [Endpoint for a generated/global search to Spotify.](http://localhost:5000/spotify/v1/search?q=QUERY&type=TYPE)
